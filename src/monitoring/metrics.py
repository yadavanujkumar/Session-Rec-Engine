...
class MetricsTracker:
    ...
    def record_recommendation(self, items_recommended: List[str], item_clicked: str = None, 
                             latency_ms: float = None, used_coldstart: bool = False):
        """
        ...
        with self.lock:
            return {
                ...
                "coldstart_percentage": round(
                    (self.coldstart_requests / self.total_requests * 100) if self.total_requests > 0 else 0.0,
                    2
                )
            }
